...
bool SponzaExe::LoadContent()
{
    ...
    }   
    {
        ...
        sponza.AddComponent<StaticMeshComponent>("Assets/Models/crytek-sponza-noflag/sponza.obj", MeshImport::HeightAsNormal | MeshImport::IgnoreUserMaterialAlbedoOnly);
